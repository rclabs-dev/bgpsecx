...
import net.floodlightcontroller.bgpsecx.sessioncontrol.BGPSecTCPDaemon;
...
public class BGPSecMain extends ForwardingBase implements IFloodlightModule, IOFSwitchListener, ILinkDiscoveryListener,
        IRoutingDecisionChangedListener, IGatewayService {
    protected static final Logger log = LoggerFactory.getLogger(BGPSecMain.class);
    ...
    public void startUp(FloodlightModuleContext context) {
        ...
        // Clearing BGP DataRoute Server to communicate with speaks
        sessionData.clearAllSessionData();
        sessionData = new BGPSecSetGetSessionData();
        // Start BGP Route Server to communicate with adjacent peers
